#!/bin/sh
# This is an example of training fixed two-layer mgu # This is an example of training fixed two-layer delta network on c172 dataset
#
    ...
    do
        ...
        do
            ...
            do
                ...
                mkdir -p $exp_name
                echo "Training ${num_hidden_layer}-layer mgu network with c172 dataset, results will be saved to: "$exp_name
                echo "###-------------------###"

...
BP_MIN=${2:-0}
BP_MAX=${3:-1}
exp_name="../test_output/new/coal_mpi_random/bp_min${BP_MIN}_bp_max${BP_MAX}/run_${RUN_NUM}"
cd build
...
echo "=== bp_iterations_min: $BP_MIN === bp_iterations_max: $BP_MAX ==="
mkdir -p "$exp_name"
echo "Run ${RUN_NUM}/10(bp_min=$BP_MIN, bp_max=$BP_MAX): results will be saved to: $exp_name"
echo "###-------------------###"

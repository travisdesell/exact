#!/bin/sh
# This is an example of running EXAMM MPI version on pa28 dataset, output parameters are engine parameters
#
...
exp_name="../test_output/pa28_engine"
mkdir -p $exp_name
...
--validation_filenames ../datasets/2019_ngafid_transfer/pa28_file_1[0-2].csv \
--time_offset 1 \

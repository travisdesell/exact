#!/bin/sh
# This is an example of running EXAMM transfer learning code, transfer genome trained on C172 dataset to PA44 dataset
# Output parameters on trained genome are engine parameters
#
...
GENOME="../scripts/transfer_learning/c172_engine_genome.bin"

exp_name="../test_output/c172_pa44_engine"
mkdir -p $exp_name

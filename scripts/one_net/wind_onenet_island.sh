...
do
    ...
    exp_name="/home/jefhai/Dropbox/Research/experiment_results/onenet/onenet_mpi/wind_debug/chunk_$CHUNK/gen_$NUM_GEN/bp_$BP/generated_$GENERATESIZE/elite_$ELITESIZE/$i"
    mkdir -p $exp_name
    echo "Running base EXAMM code with wind dataset, results will be saved to: "$exp_name
    echo "###-------------------###"

    mpirun -np 4 ./mpi/onenet_mpi \
    --training_filenames $DATA_DIR/turbine_R80711_2013-2016_[1-9].csv $DATA_DIR/turbine_R80711_2013-2016_1[0-9].csv $DATA_DIR/turbine_R80711_2013-2016_2[0-9].csv $DATA_DIR/turbine_R80711_2013-2016_3[0-1].csv \
    --time_offset 1 \

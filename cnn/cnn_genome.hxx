...
class CNN_Genome {
   ...
   public:
    ...
    CNN_Genome(int _generation_id, int _padding, int _number_training_images, int _number_validation_images,
               ...
               float _weight_decay_delta, int _batch_size, float _epsilon, float _alpha,
               float _input_dropout_probability, float _hidden_dropout_probability, const vector<CNN_Node *> &_nodes,
               const vector<CNN_Edge *> &_edges);
    ...
    void evaluate(const ImagesInterface &images, const vector<long> &order, float &total_error,

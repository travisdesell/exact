...
class CNN_Genome {
 ...
 public:
   ...
   */
  CNN_Genome(int _generation_id, int _padding, int _number_training_images, int _number_validation_images,
  ...
  void print_progress(ostream &out, string progress_name, float total_error, int correct_predictions,
  ...
  void evaluate_images(const ImagesInterface &images, const vector<int> &batch, vector<vector<float> > &predictions,
                       int offset);
  void evaluate_images(const ImagesInterface &images, const vector<int> &batch, bool training, float &total_error,
  ...
  void evaluate(const ImagesInterface &images, const vector<long> &order, float &total_error, int &correct_predictions,
  ...
  void get_prediction_matrix(const MultiImagesInterface &images, int image_number, int stride,
                             vector<vector<vector<float> > > &prediction_matrix);
  void get_expanded_prediction_matrix(const MultiImagesInterface &images, int image_number, int stride,
                                      int prediction_class, vector<vector<float> > &extended_prediction_matrix);
};

...
class CNN_Genome {
   ...
   public:
    ...
    CNN_Genome(
        ...
        int _number_test_images, int seed, int _max_epochs, bool _reset_weights, int velocity_reset, float _mu,
        float _mu_delta, float _learning_rate, float _learning_rate_delta, float _weight_decay,
        float _weight_decay_delta, int _batch_size, float _epsilon, float _alpha, float _input_dropout_probability,
        float _hidden_dropout_probability, const vector<CNN_Node*>& _nodes, const vector<CNN_Edge*>& _edges
    );
    ...
    void stochastic_backpropagation(
    ...
    void get_prediction_matrix(
        const MultiImagesInterface& images, int image_number, int stride,
        vector<vector<vector<float> > >& prediction_matrix
    );
    void get_expanded_prediction_matrix(

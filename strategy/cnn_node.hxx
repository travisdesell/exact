...
class CNN_Node {
    ...
    public:
        ...
        void set_values(const Image &image, int rows, int cols, bool perform_dropout, uniform_real_distribution<double> &rng_double, minstd_rand0 &generator, double input_dropout_probability);

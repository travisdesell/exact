...
int main(int argc, char **argv) {
    ...
    ofstream outfile("large_image_lenet_new.gv");
    ...
    cout << "number large testing subimages:" << testing_images.get_number_images() << endl;
    for (int i = 0; i < testing_images.get_number_large_images(); i++) {
        cout << "\timage " << i << ", number subimages: " << testing_images.get_number_subimages(i) << endl;
    }

    genome->stochastic_backpropagation(training_images, training_images);

...
class TFT(nn.Module):
    ...
    def __init__(
        ...
        # Initialization logic for Portfolio Weights (Equal Prior)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Pooling: Use the last time step's representation (Standard for forecasting)
        # Or use mean pooling if you want the average context of the whole window
        context = out[:, -1, :] 

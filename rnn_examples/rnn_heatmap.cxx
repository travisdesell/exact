...
int main(int argc, char** argv) {
    ...
    for (int cyclone = 1; cyclone <= 12; cyclone++) {
        ...
        LOG_INFO("analyzing cyclone %d with directory: '%s'\n", cyclone, cyclone_directory.c_str());

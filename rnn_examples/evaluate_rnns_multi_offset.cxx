 ...
 * --time_offsets 1 2 4 8 --testing_filenames ~/Dropbox/1537\ MTI-RIT/boiler_hourly/database_l_minus_10.csv
 * --output_filename ~/Dropbox/1537\ MTI-RIT/2019_degruyter_results/nose_gas_temperature_predictons.csv
 *
 * ./rnn_examples/evaluate_rnns_multi_offset --genome_filenames
 * ~/Dropbox/1537\ MTI-RIT/2019_degruyter_results/boiler_best_bin_gv_files/net_plant_heat_rate/time_offset_*.bin
 * --time_offsets 1 2 4 8 --testing_filenames ~/Dropbox/1537\ MTI-RIT/boiler_hourly/database_l_minus_10.csv
 * --output_filename ~/Dropbox/1537\ MTI-RIT/2019_degruyter_results/net_plant_heat_rate_predictions.csv
 *
 * ./rnn_examples/evaluate_rnns_multi_offset --genome_filenames
 ...
 * ~/Dropbox/1537\ MTI-RIT/Field_Test_data/20190910_v0.2/cyclone3_file4.csv --output_filename
...
int main(int argc, char** argv) {
    ...
    for (int32_t i = 0; i < (int32_t) genomes.size(); i++) {
        ...
        vector<vector<double> > predictions =
            genomes[i]->get_predictions(best_parameters, testing_inputs, testing_outputs);

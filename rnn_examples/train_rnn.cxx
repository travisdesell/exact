...
int main(int argc, char **argv) {
  ...
  TrainingParameters training_parameters(bp_iterations, sequence_lower_bound, sequence_upper_bound, low_threshold,
                                         high_threshold, learning_rate, dropout_probability, mu, use_nesterov_momentum,
                                         use_high_threshold, use_low_threshold, use_regression, use_dropout,
                                         random_sequence_length);

  RNN_Genome *genome;
  if (rnn_type == "lstm") {
    genome = create_lstm(input_parameter_names, num_hidden_layers, number_inputs, output_parameter_names,
                         max_recurrent_depth, training_parameters, weight_initialize);
    ...
    genome = create_ff(input_parameter_names, num_hidden_layers, number_inputs, output_parameter_names,
                       max_recurrent_depth, training_parameters, weight_initialize, WeightType::NONE, WeightType::NONE);

...
class TimeSeriesSets {
    ...
    public:
        ...
        void export_time_series(const vector<int32_t > &series_indexes, int32_t time_offset, vector< vector< vector<double> > > &inputs, vector< vector< vector<double> > > &outputs);
        ...
        void set_training_indexes(const vector<int32_t > &_training_indexes);
        void set_test_indexes(const vector<int32_t > &_test_indexes);

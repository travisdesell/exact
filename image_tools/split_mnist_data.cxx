...
int main(int argc, char **argv) {
    if (argc != 7) {
        ...
        cerr << "usage: " << endl;
        cerr << "    " << argv[0]
             << " <mnist image file> <mnist label file> <output training file> <output validation file> <expected "
                "number of images> <validation images per label"
             << endl;
        exit(1);
    }
    ...
    cout << "validation file '" << output_filename_validation << " will have " << images_per_label
         << " images per label." << endl;

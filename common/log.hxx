...
struct Log {
    ...
    /**
     * Thread local map of string to output file; used so the lock to grab output_files may not have to be grabbed.
     */
    // inline static thread_local unordered_map<string, shared_ptr<LogFile>, LogHasher> output_files_local;
    inline static thread_local unordered_map<string, shared_ptr<LogFile>> output_files_local;
    // inline static thread_local map<string, shared_ptr<LogFile>, LogComparator> output_files_local;
    // inline static thread_local map<string, shared_ptr<LogFile>> output_files_local;

...
class Corpus {
 ...
 public:
  ...
  static Corpus *generate_test(const vector<string> &_test_filenames, const vector<string> &_input_parameter_names,
  ...
  void export_sent_series(const vector<int> &series_indexes, int word_offset, vector<vector<vector<double> > > &inputs,
                          vector<vector<vector<double> > > &outputs);

  void export_training_series(int word_offset, vector<vector<vector<double> > > &inputs,
                              vector<vector<vector<double> > > &outputs);

  void export_test_series(int word_offset, vector<vector<vector<double> > > &inputs,
                          vector<vector<vector<double> > > &outputs);

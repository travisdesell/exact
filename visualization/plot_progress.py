...
min_fitness = [row[1] for row in v1]
...
plt.savefig('./progress_fitness.png')

min_epochs = [row[4] for row in v1]
avg_epochs = [row[5] for row in v1]
max_epochs = [row[6] for row in v1]
...
plt.savefig('./progress_epochs.png')


disable_edge = [row[7] for row in v1]
enable_edge = [row[8] for row in v1]
split_edge = [row[9] for row in v1]
add_edge = [row[10] for row in v1]
change_size = [row[11] for row in v1]
...
plt.savefig('./progress_statistics.png')

...
class IslandSpeciationStrategy : public SpeciationStrategy {
    private:
        ...
        RepopulationMethod repopulation_method; /**< The method used to repopulate the island after being erased */
        ...
        Work *generate_work_for_filled_island(uniform_real_distribution<double> &rng_0_1, minstd_rand0 &generator, Island *island);
        Work *generate_work_for_initializing_island(uniform_real_distribution<double> &rng_0_1, minstd_rand0 &generator, Island *island);
        Work *generate_work_for_reinitializing_island(uniform_real_distribution<double> &rng_0_1, minstd_rand0 &generator, Island *island);
    ...
    public:
         ...
         */
        Work* parents_repopulation(RepopulationMethod method, uniform_real_distribution<double> &rng_0_1, minstd_rand0 &generator);

...
private:
  ...
  bool seed_genome_was_minimal; /**< is true if we passed in a minimal genome
  ...
  Work *
  generate_work_for_filled_island(uniform_real_distribution<double> &rng_0_1,
                                  minstd_rand0 &generator, Island *island);
  Work *generate_work_for_initializing_island(
      uniform_real_distribution<double> &rng_0_1, minstd_rand0 &generator,
      Island *island);
  Work *generate_work_for_reinitializing_island(
      uniform_real_distribution<double> &rng_0_1, minstd_rand0 &generator,
      Island *island);
...
public:
  ...
  IslandSpeciationStrategy(
      ...
      uint32_t _extinction_event_generation_number,
      uint32_t _repopulation_mutations, uint32_t _islands_to_exterminate,
      bool seed_genome_was_minimal, function<void(RNN_Genome *)> &modify,
      GenomeOperators &genome_operators);
   ...
   */
  Work *parents_repopulation(RepopulationMethod method,

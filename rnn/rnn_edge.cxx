...
void RNN_Edge::propagate_forward(int time) {
    ...
    // cout << "NODE[" <<input_node->get_innovation_number()  << input_node << "]: " << output << endl;
    ...
    outputs[time] = output;
    // cout << "Before THIS IS THE OUTPUT NODE INNOVATION NUMBER: " << output_node->get_innovation_number() << endl;
    output_node->input_fired(time, output);
    // cout << "After THIS IS THE OUTPUT NODE INNOVATION NUMBER: " << output_node->get_innovation_number() << endl;
}

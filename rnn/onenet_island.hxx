#ifndef EXAMM_ONENET_ISLAND_STRATEGY_HXX
#define EXAMM_ONENET_ISLAND_STRATEGY_HXX
...
class OneNetIsland {
    private:
        ...
        int32_t status; /**> The status of this island (either OneNetIsland:INITIALIZING, OneNetIsland::FILLED or  OneNetIsland::REPOPULATING */
    ...
    public:
         ...
         */
        OneNetIsland(int32_t id, int32_t _generated_size, int32_t _elite_size);
         ...
         */
        OneNetIsland(int32_t id, Population* _elite_population, int32_t _generated_size, int32_t _elite_size);
        ...
        /**
         * Returns true if the island has OneNetIsland::max_size genomes.
         *

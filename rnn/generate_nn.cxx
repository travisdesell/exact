...
RNN_Genome* create_ff(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize, WeightType weight_inheritance, WeightType mutated_component_weight) {
...
RNN_Genome* create_jordan(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_elman(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_lstm(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_ugrnn(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_gru(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_enarc(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_enas_dag(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_random_dag(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_mgu(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {
...
RNN_Genome* create_delta(const vector<string> &input_parameter_names, uint32_t number_hidden_layers, uint32_t number_hidden_nodes, const vector<string> &output_parameter_names, uint32_t max_recurrent_depth, WeightType weight_initialize) {

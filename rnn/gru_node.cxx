...
GRU_Node::GRU_Node(int _innovation_number, int _type, double _depth)
...
void GRU_Node::initialize_kaiming(minstd_rand0 &generator,
                                  NormalDistribution &normal_distribution,
                                  double range) {
...
void GRU_Node::initialize_uniform_random(

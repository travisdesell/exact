...
private:
  ...
  // int32_t latest_inserted_generation_id; /**< The latest generation id of
  // genome being generated, including the ones doing backprop by workers */

  vector<int32_t> inserted_genome_id;
  /**
   * The genomes on this species, stored in sorted order best (front) to worst
   * (back).
   */
...
public:
   ...
   * \return the best genome in the island
   */
  RNN_Genome *get_random_genome(uniform_real_distribution<double> &rng_0_1,
   ...
   */
  void copy_random_genome(uniform_real_distribution<double> &rng_0_1,
   ...
   */
  void copy_two_random_genomes(uniform_real_distribution<double> &rng_0_1,
                               minstd_rand0 &generator, RNN_Genome **genome1,
                               RNN_Genome **genome2);

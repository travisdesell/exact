...
double sigmoid_derivative(double input) { return input * (1 - input); }

double identity(double value) { return value; }

double identity_derivative() { return 1.0; }
...
RNN_Node_Interface::RNN_Node_Interface(int32_t _innovation_number, int32_t _layer_type, double _depth,
    ...
    if (layer_type == HIDDEN_LAYER) {
        Log::fatal("ERROR: assigned a parameter name '%s' to a hidden node! This should never happen.",
...
int32_t RNN_Node_Interface::get_node_type() const { return node_type; }

int32_t RNN_Node_Interface::get_layer_type() const { return layer_type; }

int32_t RNN_Node_Interface::get_innovation_number() const { return innovation_number; }

int32_t RNN_Node_Interface::get_total_inputs() const { return total_inputs; }

int32_t RNN_Node_Interface::get_total_outputs() const { return total_outputs; }

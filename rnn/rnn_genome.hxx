...
class RNN_Genome {
   ...
   public:
    ...
    RNN_Node_Interface *create_node(double mu, double sigma, int node_type,
    ...
    void update_innovation_counts(function<int32_t()> &get_next_node_innovation_count,
                                  function<int32_t()> &get_next_edge_innovation_count);
...
struct sort_genomes_by_fitness {
    ...
    bool operator()(const shared_ptr<const RNN_Genome> &a, const shared_ptr<const RNN_Genome> &b) { return a->get_fitness() < b->get_fitness(); }
};

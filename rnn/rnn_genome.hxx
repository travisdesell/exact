...
public:
  ...
  double
  calculate_fitness(const vector<vector<vector<double>>> &validation_inputs,
  ...
  void get_input_edges(int32_t node_innovation, vector<RNN_Edge *> &input_edges,
  ...
  slice_time_series(uint32_t start_index, uint32_t sequence_length,
  ...
  vector<vector<double>>
  get_predictions(const vector<double> &parameters,
                  const vector<vector<vector<double>>> &inputs,
                  const vector<vector<vector<double>>> &outputs);
  ...
  RNN_Node_Interface *
  create_node(double mu, double sigma, int node_type,
  ...
  bool
  connect_new_input_node(double mu, double sig, RNN_Node_Interface *new_node,
                         uniform_int_distribution<int32_t> dist,
                         function<int32_t()> &get_next_edge_innovation_count,
                         bool not_all_hidden);
  bool
  connect_new_output_node(double mu, double sig, RNN_Node_Interface *new_node,
                          uniform_int_distribution<int32_t> dist,
                          function<int32_t()> &get_next_edge_innovation_count,
                          bool not_all_hidden);

  void
  update_innovation_counts(function<int32_t()> &get_next_node_innovation_count,
                           function<int32_t()> &get_next_edge_innovation_count);

  vector<RNN_Node_Interface *>
  pick_possible_nodes(int layer_type, bool not_all_hidden, string node_type);

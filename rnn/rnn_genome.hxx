...
class RNN_Genome {
    ...
    public:
        ...
        void resn_fitness(const vector< vector< vector<double> > > &inputs, const vector< vector< vector<double> > > &outputs, const vector< vector< vector<double> > > &validation_inputs, const vector< vector< vector<double> > > &validation_outputs, bool random_sequence_length, int n_samples, int sample_length);
        ...
        WeightType get_weight_initialize();
        void set_weight_initialize(string weight_initialize_string);

#ifndef EXAMM_OUTPUT_NODE_GP_HXX
#define EXAMM_OUTPUT_NODE_GP_HXX
...
class OUTPUT_Node_GP : public RNN_Node {
   public:
    // constructor for output nodes
    OUTPUT_Node_GP(int32_t _innovation_number, int32_t _layer_type, double _depth, string _parameter_name);

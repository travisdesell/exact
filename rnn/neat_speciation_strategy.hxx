...
private:
  ...
  RNN_Genome *minimal_genome; /**< keep a reference to a minimal genome so we
...
public:
  NeatSpeciationStrategy(double _mutation_rate,
                         double _intra_island_crossover_rate,
                         double _inter_island_crossover_rate,
                         RNN_Genome *_seed_genome, double _species_threshold,
                         double _fitness_threshold, double _neat_c1,

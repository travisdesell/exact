#ifndef EXAMM_SUM_NODE_GP_HXX
#define EXAMM_SUM_NODE_GP_HXX
...
class SUM_Node_GP : public RNN_Node {
   public:
    // constructor for hidden nodes
    SUM_Node_GP(int32_t _innovation_number, int32_t _layer_type, double _depth);

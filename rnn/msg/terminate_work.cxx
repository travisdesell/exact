...
void TerminateWork::write_to_stream(ostream &bin_ostream) { bin_ostream.put(TerminateWork::class_id); }

RNN_Genome *TerminateWork::get_genome(GenomeOperators &operators) { return NULL; }

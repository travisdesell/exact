...
EXAMM::EXAMM(int32_t population_size, int32_t number_islands, int32_t max_genomes, int32_t _max_time_minutes,
    ...
    if (speciation_method.compare("island") == 0 || speciation_method.compare("") == 0) {
        ...
        speciation_strategy = new IslandSpeciationStrategy(
            number_islands, population_size, seed_genome, island_ranking_method, repopulation_method,
            extinction_event_generation_number, repopulation_mutations, islands_to_exterminate,
            seed_genome_was_minimal, modify, genome_operators);

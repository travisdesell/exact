...
void UGRNN_Node::input_fired(int time, double incoming_output) {
  ...
  // reset alpha, beta1, beta2 so they don't mess with mean/stddev calculations
  // for parameter generation g_bias -= 1.0;
}
...
uint32_t UGRNN_Node::get_number_weights() const { return NUMBER_UGRNN_WEIGHTS; }
...
void UGRNN_Node::reset(uint32_t _series_length) {

#ifndef EXAMM_ONENET_ISLAND_SPECIATION_STRATEGY_HXX
#define EXAMM_ONENET_ISLAND_SPECIATION_STRATEGY_HXX
...
class OneNetIslandSpeciationStrategy : public SpeciationStrategy {
    private:
        ...
        int32_t generated_genome_size; /**< the maximum number of genomes in an island. */
         ...
         */
        vector<OneNetIsland*> islands;
        RNN_Genome* global_best_genome;

    public:
        //static void register_command_line_arguments();
        //static OneNetIslandSpeciationStrategy* generate_from_command_line();

        /**
         * Creates a new OneNetIslandSpeciationStrategy.
         *
         ...
         */
        OneNetIslandSpeciationStrategy(int32_t _number_of_islands, int32_t _generated_genome_size, int32_t _elite_genome_size,
         ...
         */
        // OneNetIslandSpeciationStrategy(int32_t _number_of_islands, int32_t _max_island_size,
        //                         double _mutation_rate, double _intra_island_crossover_rate,
        //                         double _inter_island_crossover_rate, RNN_Genome *_seed_genome,
        //                         string _island_ranking_method, string _repopulation_method,
        //                         int32_t _extinction_event_generation_number, int32_t _repopulation_mutations,

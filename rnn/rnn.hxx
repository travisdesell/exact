...
class RNN {
    ...
    public:
        ...
        void write_predictions(string output_filename, const vector<string> &output_parameter_names, const vector< vector<double> > &series_data, const vector< vector<double> > &expected_outputs, bool using_dropout, double dropout_probability);
